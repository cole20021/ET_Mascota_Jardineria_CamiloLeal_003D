...
from .views import index,gracias,quienessomos,ProductosStock, mostrarprod, formproductos, Feriados,modificarprod,eliminarprod,mostrarclientes,formclientes,modificarclientes,eliminarclientes
urlpatterns=[
